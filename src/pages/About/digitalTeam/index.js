                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="ww-do-two-content rmb-65 wow fadeInUp delay-0-2s" ><div class="section-title mb-30">
                            ...
                            <div class="ww-do-btns"><a class="theme-btn mt-15" href="/about">Create Your Website <i class="fas fa-angle-double-right"></i></a><a href="https://www.youtube.com/watch?v=9Y7ma241N8k" class="mfp-iframe video-play-text mt-15"><i class="fas fa-play"></i> <span>Watch Videos</span></a></div></div></div><div class="col-lg-6"><div class="ww-do-two-images rel"><div class="row"><div class="col-sm-7 offset-1"><img class="image-one wow fadeInUp delay-0-4s" src={Women} alt="What We Do" /></div>
                            <div class="col-sm-4"><img class="image-two wow fadeInUp delay-0-6s" src={Img2} alt="What We Do" />
                                <img class="image-three wow fadeInUp delay-0-8s" src={Img3} alt="What We Do"
                                /></div>
                            </div><div class="year-of-experience wow zoomIn delay-0-6s" ><span class="number">25</span>Years Of Web Experience</div></div></div></div></div></section>
    )
}
