          ...
          <div class="col-xl-5 col-lg-6">
            <div class="ww-do-two-content rmb-65 wow fadeInUp delay-0-2s">
              ...
              <div class="ww-do-btns d-flex">
                <a class="theme-btn mt-15" href="/about">
                  Create Your Website
            ...
            <div class="ww-do-two-images rel">
              <div class="row">
                <div class="col-sm-7 offset-1">
                  <img
                    class="image-one wow fadeInUp delay-0-4s"
                    src={Women}
                    alt="What We Do"
                  />
                </div>
                <div class="col-sm-4 imagees">
                  <img
                    class="image-two wow fadeInUp delay-0-6s image1"
                    src={Img2}
                    alt="What We Do"
                  />
                  <img
                    class="image-three wow fadeInUp delay-0-8s image2"
                    src={Img3}
                    alt="What We Do"
                  />
                </div>
              ...
              <div class="year-of-experience wow zoomIn delay-0-6s">
                <span class="number">25</span>Years Of Web Experience
              </div>
            </div>
          </div>
        </div>
